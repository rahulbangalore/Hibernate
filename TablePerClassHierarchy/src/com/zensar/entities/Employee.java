 ...
 * @modification date 27th sept 2019 11.24am
 * @description 
 *
 */
...
@Inheritance(strategy = InheritanceType.SINGLE_TABLE) //table per class hierachy

@DiscriminatorColumn(name = "emp_type",discriminatorType = DiscriminatorType.CHAR) //crating table name as 'emp_type' and its type of string
